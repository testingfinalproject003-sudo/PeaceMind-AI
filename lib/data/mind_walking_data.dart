...
/// Mind Walking (mindful walking meditation) with multi-language narration.
final List<ExerciseStep> mindWalkingSteps = [
  ExerciseStep(
    label: {
      AppLang.en: 'Stand & Notice',
      AppLang.ur: 'کھڑے ہوں اور محسوس کریں',
      AppLang.urRoman: 'Kharay Hon aur Mehsoos Karein',
      AppLang.pa: 'ਖੜ੍ਹੇ ਹੋਵੋ ਅਤੇ ਮਹਿਸੂਸ ਕਰੋ',
    },
    text: {
      AppLang.en:
      ...
      AppLang.pa:
      'ਜੀ ਆਇਆਂ ਨੂੰ। ਇੱਕ ਸ਼ਾਂਤ ਥਾਂ ਲੱਭੋ, ਅੰਦਰ ਜਾਂ ਬਾਹਰ, ਜਿੱਥੇ ਤੁਸੀਂ ਕੁਝ ਹੌਲੀ ਕਦਮ ਅੱਗੇ-ਪਿੱਛੇ ਲੈ ਸਕੋ। ਸਥਿਰ ਖੜ੍ਹੇ ਹੋਵੋ। ਆਪਣੇ ਪੈਰ ਜ਼ਮੀਨ ਵਿੱਚ ਜੜ੍ਹੇ ਹੋਏ ਮਹਿਸੂਸ ਕਰੋ, ਭਾਰ ਬਰਾਬਰ ਵੰਡਿਆ ਹੋਵੇ। ਹੌਲੀ ਸਾਹ ਅੰਦਰ ਲਵੋ... ਅਤੇ ਬਾਹਰ। ਕਿਤੇ ਜਲਦੀ ਨਹੀਂ — ਇਸ ਸੈਰ ਦਾ ਮਕਸਦ ਸਿਰਫ਼ ਇਹ ਪਲ ਹੈ।',
    },
    duration: const Duration(milliseconds: 20000),
  ),
  ExerciseStep(
    label: {
      AppLang.en: 'First Steps',
      AppLang.ur: 'پہلے قدم',
      AppLang.urRoman: 'Pehle Qadam',
      AppLang.pa: 'ਪਹਿਲੇ ਕਦਮ',
    },
    text: {
      AppLang.en:
      ...
      AppLang.pa:
      'ਚੱਲਣਾ ਸ਼ੁਰੂ ਕਰੋ, ਆਮ ਨਾਲੋਂ ਹੌਲੀ। ਹਰ ਕਦਮ ਨਾਲ ਮਹਿਸੂਸ ਕਰੋ ਕਿ ਅੱਡੀ ਕਿਵੇਂ ਉੱਠਦੀ ਹੈ, ਭਾਰ ਕਿਵੇਂ ਬਦਲਦਾ ਹੈ, ਪੈਰ ਹੌਲੀ ਨਾਲ ਜ਼ਮੀਨ \'ਤੇ ਵਾਪਸ ਆਉਂਦਾ ਹੈ। ਜੇ ਮਨ ਕੰਮ ਦੀ ਸੂਚੀ ਜਾਂ ਮਾੜੇ ਵੱਲ ਭਟਕੇ, ਨਰਮੀ ਨਾਲ ਇਸਨੂੰ ਚੱਲਣ ਦੇ ਸੌਖੇ ਅਹਿਸਾਸ \'ਤੇ ਵਾਪਸ ਲਿਆਓ, ਇੱਕ ਕਦਮ ਇੱਕ ਸਮੇਂ ਵਿੱਚ।',
    },
    duration: const Duration(milliseconds: 28000),
  ),
  ExerciseStep(
    label: {
      AppLang.en: 'Whole-Body Awareness',
      AppLang.ur: 'مکمل جسمانی آگاہی',
      AppLang.urRoman: 'Mukammal Jismani Aagahi',
      AppLang.pa: 'ਪੂਰੇ ਸਰੀਰ ਦੀ ਜਾਗਰੂਕਤਾ',
    },
    text: {
      AppLang.en:
      ...
      AppLang.pa:
      'ਹੁਣ ਆਪਣੀ ਜਾਗਰੂਕਤਾ ਵਧਾਓ। ਬਾਹਾਂ ਦੀ ਨਰਮ ਹਿੱਲਜੁਲ ਮਹਿਸੂਸ ਕਰੋ, ਸਾਹ ਦੀ ਤਾਲ ਕਦਮਾਂ ਨਾਲ ਮਿਲਦੀ ਹੈ, ਹਵਾ ਚਮੜੀ ਤੋਂ ਲੰਘ ਰਹੀ ਹੈ। ਆਲੇ-ਦੁਆਲੇ ਦੀਆਂ ਆਵਾਜ਼ਾਂ ਸੁਣੋ ਬਿਨਾਂ ਨਾਮ ਦਿੱਤੇ। ਹਰ ਕਦਮ ਨਾਲ ਕਲਪਨਾ ਕਰੋ ਕਿ ਤੁਸੀਂ ਜ਼ਮੀਨ ਵਿੱਚ ਥੋੜ੍ਹੀ ਸ਼ਾਂਤੀ ਰੱਖ ਰਹੇ ਹੋ, ਹਰ ਨਕਸ਼-ਕਦਮ ਨਾਲ ਤਣਾਅ ਪਿੱਛੇ ਛੱਡ ਰਹੇ ਹੋ।',
    },
  ...
  ExerciseStep(
    ...
    text: {
      ...
      AppLang.pa:
      'ਬਹੁਤ ਵਧੀਆ। ਹੌਲੀ ਨਾਲ ਰੁਕੋ ਅਤੇ ਇੱਕ ਵਾਰ ਫਿਰ ਸਥਿਰ ਖੜ੍ਹੇ ਹੋਵੋ। ਸਰੀਰ ਵਿੱਚ ਫ਼ਰਕ ਮਹਿਸੂਸ ਕਰੋ — ਵੱਧ ਮਜ਼ਬੂਤ, ਵੱਧ ਮੌਜੂਦ, ਵੱਧ ਇੱਥੇ। ਇੱਕ ਆਖ਼ਰੀ ਸਾਹ ਅੰਦਰ ਲਵੋ... ਅਤੇ ਬਾਹਰ। ਇਸ ਬਿਨਾ ਜਲਦੀ, ਪੂਰੀ ਤਵੱਜੋ ਵਾਲੀ ਗਤੀ ਨੂੰ ਆਪਣੇ ਨਾਲ ਆਪਣੇ ਦਿਨ ਵਿੱਚ ਲੈ ਕੇ ਚੱਲੋ।',
    },
