...
final List<ExerciseStep> bodyScanSteps = [
  ExerciseStep(
    ...
    text: {
      ...
      AppLang.zh: '欢迎。请轻轻闭上眼睛,或将视线柔和地向下。找一个舒适的姿势坐好,背部挺直,双手放在腿上。用鼻子缓慢吸气,数到四……稍作停顿……然后用嘴巴缓慢呼气,数到六,让肩膀放松下沉。想象一道温暖的金色光芒缓缓充满你的胸腔,将平静传遍全身。让我们再一起深呼吸一次,吸气……呼气。感受自己完全安住在这一刻。',
  ...
  ExerciseStep(
    ...
    text: {
      ...
      AppLang.zh: '现在把注意力放在肩膀和颈部。慢慢将肩膀向耳朵方向抬起,感受紧张感……保持三、二、一……然后完全放松。当肩膀放下时,感受一股暖流扩散开来,肌肉变得柔软而沉重。想象所有紧张像阳光下的冰一样融化。轻轻左右转动颈部,持续均匀呼吸。每次呼气时,想象紧张如潮水般退去。',
  ...
  ExerciseStep(
    ...
    text: {
      ...
      AppLang.zh: '闭上眼睛,让你的意识缓缓向下移动,仿佛一道柔和的光在身体中游走——从颈部,经过肩膀和手肘,到胸部和髋部,再经过膝盖,最后到达双脚。每当光芒经过一个部位时,想象那块肌肉发出温暖的光芒,逐渐放松并释放紧张。想象每一个紧张点都融化在柔和平静的光芒中。你是安全的。你是放松的。让你的整个身体感觉轻盈,毫无负担。',
  ...
  ExerciseStep(
    ...
    text: {
      ...
      AppLang.zh: '做得非常好。再深吸一口气……然后缓缓呼出。感受一下你的身体现在的感觉——比之前更轻盈、更放松、更平静。当你准备好时,轻轻睁开眼睛。带着这份平静回到你的一天中去。',
