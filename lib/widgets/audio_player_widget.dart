...
import '../services/nova_text_sanitizer.dart';
...
class _AudioPlayerWidgetState extends State<AudioPlayerWidget> {
  ...
  Future<void> _speak() async {
    ...
    try {
      ...
      // Start speaking — only plain words ever reach the TTS engine.
      await _tts.speak(NovaTextSanitizer.sanitize(widget.text));
